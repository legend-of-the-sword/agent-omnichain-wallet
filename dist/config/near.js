    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    connection = _a.sent();
                    return [4 /*yield*/, connection.account(process.env.NEXT_PUBLIC_NEAR_ACCOUNT_ID)];
                case 2:
                    account = _a.sent();
                    return [2 /*return*/, { connection: connection, account: account }];
            }
        });
    });
}
exports.default = initNear;
